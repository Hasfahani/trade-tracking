...
``market_resolutions`` outcomes. Pure-numpy logistic regression - no tensorflow
...
def main() -> int:
    ...
    from app.ml.outcome_train import train_outcome_and_export
    ...
    print("Building resolved-market dataset and training the outcome model...")
    try:
